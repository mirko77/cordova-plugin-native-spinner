  ...
  show: function (title, message, cancelCallback, iosOptions) {
    ...
    if (isPlatformIos) {
      if (typeof iosOptions != "object") {
        iosOptions = { overlayOpacity: 0.35, textColorRed: 1, textColorGreen: 1, textColorBlue: 1,  fontSize: 10.0}
      }
      params = params.concat([(iosOptions.overlayOpacity || 0.35), (iosOptions.textColorRed || 1), (iosOptions.textColorGreen || 1), (iosOptions.textColorBlue || 1), (iosOptions.fontSize || 10.0)])
    }
